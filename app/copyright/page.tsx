        ...
        <div className="max-w-4xl mx-auto">
          ...
          <Card className="mb-8">
            <CardContent className="p-8 prose dark:prose-invert max-w-none">
              ...
              <p>
                <strong>MovieLovers.in</strong> is committed to respecting the intellectual property rights of others. We comply with the <strong>DMCA (1998, USA)</strong>, the <strong>Copyright Act, 1957 (India)</strong> (as amended in 2012), and the <strong>Information Technology Act, 2000 (India)</strong>, including the <em>Intermediary Guidelines and Digital Media Ethics Code Rules, 2021</em>.
              </p>
              ...
              <p>
                Email your notice to: <a href="mailto:admin@movielovers.in" className="text-primary hover:underline">admin@movielovers.in</a><br />
              ...
              <p>
                Email your counter-notice to: <a href="mailto:admin@movielovers.in" className="text-primary hover:underline">admin@movielovers.in</a><br />
              ...
              <p>
                <strong>Email:</strong> <a href="mailto:admin@movielovers.in" className="text-primary hover:underline">admin@movielovers.in</a><br />
