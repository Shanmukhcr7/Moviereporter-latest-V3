...
export function MovieClient({ initialId }: { initialId?: string }) {
    const params = useParams()
    const router = useRouter()
    // Use initialId for better server composition support
    const movieId = (initialId || params.id) as string
    ...
    }, [movieId, user, isRatingModalOpen])
